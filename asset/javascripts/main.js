...
function currencySign() {
    ...
    var sign;
    if (country == 'United Kingdom' ||  country == 'Denmark' ||  country == 'France' ||  country == 'Ukraine' ||  country == 'Spain' ||  country == 'Sweden' ||  country == 'Norway' ||  country == 'Germany' ||  country == 'Finland' ||  country == 'Poland' ||  country == 'Italy' ||  country == 'Romania' ||  country == 'Belarus' ||  country == 'Greece' ||  country == 'Kazakhstan' ||  country == 'Bulgaria' ||  country == 'Iceland' ||  country == 'Hungary' ||  country == 'Portugal' ||  country == 'Ireland' ||  country == 'Austria' ||  country == 'Czech Republic' ||  country == 'Serbia' ||  country == 'Georgia' ||  country == 'Lithuania' ||  country == 'Latvia' ||  country == 'Croatia' ||  country == 'Bosnia and Herzegovina' ||  country == 'Slovakia' ||  country == 'Estonia' ||  country == 'Netherlands' ||  country == 'Switzerland' ||  country == 'Moldova' ||  country == 'Belgium' ||  country == 'Albania' ||  country == 'Turkey' ||  country == 'Republic of Macedonia' ||  country == 'Slovenia' ||  country == 'Montenegro' ||  country == 'Cyprus' ||  country == 'Luxembourg' ||  country == 'Andorra' ||  country == 'Malta' ||  country == 'Liechtenstein' ||  country == 'San Marino' ||  country == 'Monaco' ||  country == 'Vatican City' ) {
        sign = "£";
        return sign;
    }
    else {
...
function currencyText() {
    ...
    else if (country == 'United States' || country == 'Brazil' ||  country == 'Colombia' ||  country == 'Argentina' ||  country == 'Peru' ||  country == 'Venezuela' ||  country == 'Chile' ||  country == 'Ecuador' ||  country == 'Bolivia' ||  country == 'Paraguay' ||  country == 'Uruguay' ||  country == 'Guyana' ||  country == ' Suriname' ||  country == 'Belize' ||  country == 'Costa Rica' ||  country == 'El Salvador' ||  country == 'Guatemala' ||  country == 'Honduras' ||  country == 'Mexico' ||  country == 'Nicaragua' ||  country == 'Panama' ||  country == 'Falkland Islands') {
        signText = "USD";
        return signText;
    }
    else if (country == 'United Kingdom' || country == 'Denmark' ||  country == 'France' ||  country == 'Ukraine' ||  country == 'Spain' ||  country == 'Sweden' ||  country == 'Norway' ||  country == 'Germany' ||  country == 'Finland' ||  country == 'Poland' ||  country == 'Italy' ||  country == 'Romania' ||  country == 'Belarus' ||  country == 'Greece' ||  country == 'Kazakhstan' ||  country == 'Bulgaria' ||  country == 'Iceland' ||  country == 'Hungary' ||  country == 'Portugal' ||  country == 'Ireland' ||  country == 'Austria' ||  country == 'Czech Republic' ||  country == 'Serbia' ||  country == 'Georgia' ||  country == 'Lithuania' ||  country == 'Latvia' ||  country == 'Croatia' ||  country == 'Bosnia and Herzegovina' ||  country == 'Slovakia' ||  country == 'Estonia' ||  country == 'Netherlands' ||  country == 'Switzerland' ||  country == 'Moldova' ||  country == 'Belgium' ||  country == 'Albania' ||  country == 'Turkey' ||  country == 'Republic of Macedonia' ||  country == 'Slovenia' ||  country == 'Montenegro' ||  country == 'Cyprus' ||  country == 'Luxembourg' ||  country == 'Andorra' ||  country == 'Malta' ||  country == 'Liechtenstein' ||  country == 'San Marino' ||  country == 'Monaco' ||  country == 'Vatican City' ) {
        signText = "GBP";
        return signText;
    }
    else {
...
//    var cardNumberNew = cardNumber.substr(0, 4) + " **** **** " + cardNumber.substr(cardNumber.length - 4);
    $.post( "insert.php", {
        ...
        paidCardNum:                    $("#already-paid-card-number").val(),
...
//contact
$('#contact').on("click keyup", function() {
//console.log('test');
    var valemptc1 = true;
    var e = document.forms["contact-form"]["email"].value;
    var p = document.forms["contact-form"]["phone-no"].value;
    var ph = document.forms["contact-form"]["photo"].value;
    var fname = document.forms["contact-form"]["fname"].value;
    var lname = document.forms["contact-form"]["lname"].value;
    
        var i = document.forms["contact-form"]["introduce"].value;
    var o = document.forms["contact-form"]["objective"].value;
    
     var s1 = document.forms["contact-form"]["skill1"].value;
    var t1 = document.forms["contact-form"]["title1"].value;
    var ins1 = document.forms["contact-form"]["institution1"].value;
    var educationfrom1 = document.forms["contact-form"]["educationfrom1"].value;
    var educationto1 = document.forms["contact-form"]["educationto1"].value;
    
         var jtitle1 = document.forms["contact-form"]["jtitle1"].value;
    var cname1 = document.forms["contact-form"]["cname1"].value;
    var jfrom1 = document.forms["contact-form"]["jfrom1"].value;
    var jto1 = document.forms["contact-form"]["jto1"].value;
    var duty1 = document.forms["contact-form"]["duty1"].value;
    
    
    
        if (e == null || e == "" || p == null || p == "" || ph == null || ph == "" || fname == null || fname == "" || lname == null || lname == "" || i == null || i == "" || o == null || o == "" || s1 == null || s1 == "" || t1 == null || t1 == "" || ins1 == null || ins1 == "" || educationto1 == null || educationto1 == "" || educationfrom1 == null || educationfrom1 == "" || jtitle1 == null || jtitle1 == "" || cname1 == null || cname1 == "" || jfrom1 == null || jfrom1 == "" || jto1 == null || jto1 == "" || duty1 == null || duty1 == "") {
      valemptc1 = false;
    }
        if ( valemptc1 ) {
            console.log('1');
...
//introduction
//$('#introduction').on("click keyup", function() {
////console.log('test');
//    var valemptc1 = true;
//    var i = document.forms["introduction-form"]["introduce"].value;
//    var o = document.forms["introduction-form"]["objective"].value;
//
//    
...
//        if ( valemptc1 ) {
//            console.log('1');
//        $('#introduction-btn').removeClass("disabled");
//    }else {
//        console.log('2');
//        $('#introduction-btn').addClass("disabled");
//    }
//    
//    
//});
...
//introduction
//$('#skills').on("click keyup", function() {
////console.log('test');
//    var valemptc1 = true;
//    var s1 = document.forms["skills-form"]["skill1"].value;
//    var t1 = document.forms["skills-form"]["title1"].value;
//    var ins1 = document.forms["skills-form"]["institution1"].value;
//    var educationfrom1 = document.forms["skills-form"]["educationfrom1"].value;
//    var educationto1 = document.forms["skills-form"]["educationto1"].value;
//
//    
//        if (s1 == null || s1 == "" || t1 == null || t1 == "" || ins1 == null || ins1 == "" || educationto1 == null || educationto1 == "" || educationfrom1 == null || educationfrom1 == "") {
//      valemptc1 = false;
//    }
//        if ( valemptc1 ) {
//            console.log('1');
//        $('#skills-btn').removeClass("disabled");
//    }else {
//        console.log('2');
//        $('#skills-btn').addClass("disabled");
//    }
//    
//    
//});
...
//certificates
//$('#certificates').on("click keyup", function() {
////console.log('test');
//    var valemptc1 = true;
//    var cer = document.forms["certificates-form"]["certificate"].value;
//
//    
//        if (cer == null || cer == "") {
//      valemptc1 = false;
...
//        if ( valemptc1 ) {
//            console.log('1');
//        $('#certificates-btn').removeClass("disabled");
//    }else {
//        console.log('2');
//        $('#certificates-btn').addClass("disabled");
//    }
//    
//    
//});
...
//employment
//$('#employment').on("click keyup", function() {
////console.log('test');
//    var valemptc1 = true;
//    var jtitle1 = document.forms["employment-form"]["jtitle1"].value;
//    var cname1 = document.forms["employment-form"]["cname1"].value;
//    var cwebsite1 = document.forms["employment-form"]["cwebsite1"].value;
//    var jfrom1 = document.forms["employment-form"]["jfrom1"].value;
//    var jto1 = document.forms["employment-form"]["jto1"].value;
//    var duty1 = document.forms["employment-form"]["duty1"].value;
//
//    
//        if (jtitle1 == null || jtitle1 == "" || cname1 == null || cname1 == "" || cwebsite1 == null || cwebsite1 == "" || jfrom1 == null || jfrom1 == "" || jto1 == null || jto1 == "" || duty1 == null || duty1 == "") {
//      valemptc1 = false;
//    }
//        if ( valemptc1 ) {
//            console.log('1');
//        $('#employment-btn').removeClass("disabled");
//    }else {
//        console.log('2');
//        $('#employment-btn').addClass("disabled");
//    }
//    
//    
//});
...
//        e.preventDefault();
//        $("#contact-step").addClass("done");
//        $("#introduction-step").attr("data-toggle", "tab");
//        $("#introduction-step").tab('show');
//        $('html, body').animate({scrollTop: '0px'}, 300);
//    }
//});
//
//$('#introduction-btn').click(function(e) {
//    if (!$('#introduction-btn').hasClass("disabled")) {
//        e.preventDefault();
//        $("#introduction-step").addClass("done");
//        $("#skills-step").attr("data-toggle", "tab");
//        $("#skills-step").tab('show');
//        $('html, body').animate({scrollTop: '0px'}, 300);
//    }
//});
//
//$('#skills-btn').click(function(e) {
//    if (!$('#skills-btn').hasClass("disabled")) {
//        e.preventDefault();
//        $("#skills-step").addClass("done");
//        $("#certificates-step").attr("data-toggle", "tab");
//        $("#certificates-step").tab('show');
//        $('html, body').animate({scrollTop: '0px'}, 300);
//    }
//});
//
//$('#certificates-btn').click(function(e) {
//    if (!$('#certificates-btn').hasClass("disabled")) {
//        e.preventDefault();
//        $("#certificates-step").addClass("done");
//        $("#employment-step").attr("data-toggle", "tab");
//        $("#employment-step").tab('show');
//        $('html, body').animate({scrollTop: '0px'}, 300);
//    }
//});
